...
const iconConfig: Record<Notification['type'], { name: string; color: string }> = {
  ...
  PLACE_SUGGESTION_APPROVED: { name: 'checkmark-circle', color: '#10B981' },
  PLACE_SUGGESTION_REJECTED: { name: 'close-circle', color: '#EF4444' },
  BOOKING_CONFIRMED: { name: 'checkmark-circle', color: '#10B981' },
  BOOKING_CANCELLED: { name: 'close-circle', color: '#EF4444' },
  BOOKING_COMPLETED: { name: 'ribbon', color: '#2563EB' },
  EVENT_REGISTRATION_CREATED: { name: 'person-add', color: '#8B5CF6' },
  EVENT_REGISTRATION_CANCELLED: { name: 'person-remove', color: '#EF4444' },
  EVENT_INVITATION_CREATED: { name: 'mail', color: '#8B5CF6' },
  EVENT_CANCELLED: { name: 'calendar-clear', color: '#EF4444' },
  EVENT_COMPLETED: { name: 'calendar', color: '#2563EB' },
