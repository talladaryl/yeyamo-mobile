...
export function SponsoredFeedCard({ item, height, isActive, bottomOverlayInset }: { item: SponsoredFeedItem; height: number; isActive: boolean; bottomOverlayInset: number }) {
