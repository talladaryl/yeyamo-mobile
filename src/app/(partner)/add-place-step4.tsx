          ...
          <View className="bg-[#161616] rounded-2xl overflow-hidden border border-[#27272A] mb-6">
            ...
            <View className="p-4">
              ...
              <View className="flex-row items-start justify-between mb-3">
                <View className="flex-1">
                  ...
                  <View className="flex-row items-center">
                    ...
                    <Text className="text-[#A1A1AA] text-sm ml-1">(78 avis)</Text>
                  </View>
                </View>
              </View>
              ...
              <View className="space-y-3">
                {/* Address */}
                <View>
                  <Text className="text-[#A1A1AA] text-xs font-medium mb-1">Adresse</Text>
                ...
                {/* Category */}
                <View>
                  <Text className="text-[#A1A1AA] text-xs font-medium mb-1">Catégorie</Text>
                  <Text className="text-white text-sm">
                ...
                {placeForm.phone && (
                  <View>
                    <Text className="text-[#A1A1AA] text-xs font-medium mb-1">Téléphone</Text>
                    <Text className="text-white text-sm">{placeForm.phone}</Text>
                  </View>
                )}
                ...
                {placeForm.contact_email && (
                  <View>
                    <Text className="text-[#A1A1AA] text-xs font-medium mb-1">Email</Text>
                    <Text className="text-white text-sm">{placeForm.contact_email}</Text>
                  </View>
                )}
                ...
                {placeForm.website && (
                  <View>
                    <Text className="text-[#A1A1AA] text-xs font-medium mb-1">Site web</Text>
              ...
              {(placeForm.facebook || placeForm.instagram || placeForm.twitter) && (
                <View className="mt-4 pt-4 border-t border-[#27272A]">
                  <Text className="text-[#A1A1AA] text-xs font-medium mb-2">Réseaux sociaux</Text>
                  <View className="flex-row flex-wrap gap-2">
                    {placeForm.facebook && (
                      <View className="flex-row items-center bg-[#0A0A0A] px-3 py-2 rounded-lg">
                        <Icon library="ionicons" name="logo-facebook" size={16} color="#1877F2" />
                        <Text className="text-white text-xs ml-2">{placeForm.facebook}</Text>
                      </View>
                    )}
                    {placeForm.instagram && (
                      <View className="flex-row items-center bg-[#0A0A0A] px-3 py-2 rounded-lg">
                        <Icon library="ionicons" name="logo-instagram" size={16} color="#E4405F" />
                        <Text className="text-white text-xs ml-2">{placeForm.instagram}</Text>
                      </View>
                    )}
                    {placeForm.twitter && (
                      <View className="flex-row items-center bg-[#0A0A0A] px-3 py-2 rounded-lg">
                        <Icon library="ionicons" name="logo-twitter" size={16} color="#1DA1F2" />
                        <Text className="text-white text-xs ml-2">{placeForm.twitter}</Text>
                      </View>
                    )}
                  </View>
                </View>
