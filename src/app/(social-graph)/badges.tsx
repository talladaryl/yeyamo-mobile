    ...
    <SafeAreaView className="flex-1 bg-[#0A0A0A]" edges={['top']}>
      ...
      <View className="px-4 py-3 border-b border-[#27272A]">
        <View className="flex-row items-center justify-between">
          ...
          <Text className="text-white text-xl font-bold">Mes badges</Text>
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        {stats && (
          <View className="px-4 pt-6 pb-4">
            <Text className="text-[#A1A1AA] text-sm mb-2">Niveau global</Text>
            <Text className="text-white text-3xl font-bold mb-1">Niveau {stats.level}</Text>
            <Text className="text-[#A1A1AA] text-base">{stats.rank}</Text>
            <View className="flex-row mt-4">
              <View className="flex-1 mr-2">
                <Text className="text-[#A1A1AA] text-xs">Total XP</Text>
                <Text className="text-white text-2xl font-bold">{stats.total_xp.toLocaleString()}</Text>
              </View>
              <View className="flex-1 ml-2">
                <Text className="text-[#A1A1AA] text-xs">Badges débloqués</Text>
        ...
        {mainBadge && (
          <View className="mx-4 mb-6 bg-gradient-to-br from-[#EF4444] to-[#DC2626] rounded-2xl p-6">
            <View className="flex-row items-center justify-between mb-4">
              <View>
                <Text className="text-white/80 text-sm">Niveau global</Text>
                <Text className="text-white text-2xl font-bold">{mainBadge.name}</Text>
        ...
        <View className="px-4 mb-6">
          <Text className="text-white text-lg font-bold mb-4">Mes badges</Text>
        ...
        {lockedBadges.length > 0 && (
          <View className="px-4 pb-8">
            <Text className="text-white text-lg font-bold mb-4">Badges à débloquer</Text>
