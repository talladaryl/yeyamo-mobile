...
export function RemoteAudioPlayer({ source, transcript, label = 'Écouter la prononciation' }: { source?: string | null; transcript?: string | null; label?: string }) {
